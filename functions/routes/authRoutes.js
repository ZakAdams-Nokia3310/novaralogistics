...
router.post('/set-role', authenticateToken, strictRateLimiter, requireAdmin, asyncHandler(setRole));
router.post('/set-password', authenticateToken, strictRateLimiter, requireAdmin, asyncHandler(setPassword));
router.post('/set-email', authenticateToken, strictRateLimiter, requireAdmin, asyncHandler(setEmail));
